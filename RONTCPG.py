...
def send_likes(uid):
    try:
        ...
        likes_api_response = requests.get(
            f"http://127.0.0.1:5001/like?uid={uid}&server_name=ind",
        ...
        if likes_api_response.status_code == 200:
            ...
            likes_added = api_json_response.get('LikesGivenByAPI_ThisRun', 0)
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Credits: [FFFFFF]KARTIK [00FF00]BISHNOI!!
                """
            else:
